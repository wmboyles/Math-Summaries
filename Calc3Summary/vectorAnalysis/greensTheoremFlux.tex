...
\begin{theorem}[Green's Theorem from Flux]
	Let $C$ be a closed, counter-clockwise oriented curve in $\mathbb{R}^2$ and let $D$ be the region contained within $C$. For any differentiable vector field $\vec{F}(x,y)$,\\ $$\iint\limits_{D}{\nabla\cdot\vec{f}\mathrm{D}A}=\oint\limits_{D}{\vec{F}\cdot\hat{n}\mathrm{d}s}$$
\end{theorem}
