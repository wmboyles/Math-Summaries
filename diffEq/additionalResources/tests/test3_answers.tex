...
%			\item
%				\begin{align*}
%					\Laplace{\lim\limits_{a \to 0}{\frac{1}{\abs{t}\sqrt{\pi}}e^{(t/a)^2}}} &= \int_{0}^{\infty}{e^{-st}\lim\limits_{a \to 0}{\frac{1}{\abs{t}\sqrt{\pi}}e^{(t/a)^2}} \mathrm{d}t} \\
%					&= \frac{1}{\sqrt{\pi}}\int_{0}^{\infty}{\lim\limits_{a\to 0}\frac{e^{(t/a)^2 - s}}{t} \mathrm{d}t} \text{, } t > 0
%				\end{align*}
%				Let $u = (t/a)^2 - s$, so $\mathrm{d}u = \frac{2}{a^2}t\mathrm{d}t$.
%				\begin{align*}
%					&= \frac{1}{\sqrt{\pi}}\int_{-s}^{\infty}{}
%				\end{align*}
		\end{enumerate}
	\item
		\begin{enumerate}[label=(\alph*)]
...
%			& = \frac{C_1s^3 + C_1s^2 + C_2s^2 + C_1s + C_1 + C_2 + 10}{s^2+1} \\
