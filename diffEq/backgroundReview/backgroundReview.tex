...
\input{./backgroundReview/algebraPreCalc} % Algebra and Pre-Calc
\input{./backgroundReview/singleVariableCalc} % Single Variable Calculus
\input{./backgroundReview/matrices} % Matrix operations