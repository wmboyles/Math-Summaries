...
\input{./backgroundReview/singleVariableCalc/singleVariableCalc.tex}	% Single Variable Calculus
\input{./backgroundReview/matrices/matrices.tex} 						% Matrix operations