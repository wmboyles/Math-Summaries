...
\def\includeLinearSystems{1}					% Should the linear systems of DiffEq's chapter be included?
	\def\includeLinearSystemsExamples{1}		% Should example be included in the linear systems chapter?
...
\begin{document}	
	...
	\mainmatter
		\ifodd\includeBackgroundReview\input{./backgroundReview/backgroundReview.tex}\fi 			% Background and Review
		\ifodd\includeBasics\input{./basics/basics.tex} 											% Introduction / Basics	
		\ifodd\includeFirstOrderLinearODE\input{./1stOrderLinearODE/1stOrderLinearODE.tex}\fi 		% 1st order linear ODE's
		\ifodd\includeHigherOrder\input{./higherOrder/higherOrder.tex}\fi 							% Higher (mostly 2nd) Order linear ODE's
		\ifodd\includeLinearSystems\input{./linearSystems/linearSystems.tex}\fi 					% Linear Systems of DiffEq's
		\ifodd\includeLaplaceTransforms\input{./laplaceTransforms/laplaceTransforms.tex}\fi 		% Laplace Transforms
		\ifodd\includeAdditionalResources\input{./additionalResources/additionalResources.tex}\fi	% Additional Resources
